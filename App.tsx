...
const App = () => {
    ...
    const renderView = () => {
        ...
        switch (currentView) {
            ...
            case View.Inventory:
                 return <InventoryView products={products} onUpdateProduct={updateProduct} onDeleteProductRequest={setProductToDelete} permissions={userPermissions} onAddProduct={addProduct} onImportProducts={handleImportProducts} onPrintBarcodeRequest={setProductToPrintBarcode} />;
            case View.Purchases:
