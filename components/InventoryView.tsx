...
const InventoryView = ({ products, onAddProduct, onUpdateProduct, onDeleteProductRequest, permissions, onImportProducts, onPrintBarcodeRequest }: InventoryViewProps) => {
                    ...
                    <tbody>
                        {filteredProducts.map(product => (
                         ...
                         {filteredProducts.length === 0 && (
                            <tr>
                                <td colSpan={8} className="text-center py-10 text-slate-500 dark:text-slate-400">No products found. Add products via the "New Product" button.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
