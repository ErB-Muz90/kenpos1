                        ...
                        <h4 className="text-lg font-bold text-slate-800">Enter Starting Float</h4>
                         <form onSubmit={handleConfirmStartShift} className="w-full space-y-4">
                            ...
                            <div className="flex space-x-2">
                                <motion.button type="button" onClick={() => setIsFloatPromptOpen(false)} whileTap={{ scale: 0.95 }} className="flex-1 bg-slate-100 text-slate-700 font-bold py-2 rounded-lg hover:bg-slate-200 transition-colors">Cancel</motion.button>
            ...
            <div className="p-4 border-b border-slate-200 bg-slate-50">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className={`text-sm font-bold ${activeShift ? 'text-green-600' : 'text-slate-500'}`}>
            ...
            <div className="p-4 border-t border-slate-200 bg-slate-50 space-y-2">
                ...
                {discountSettings.enabled && (
                    <div className="flex justify-between items-center text-sm">
                        ...
                        <input 
                          ...
                          className="w-20 text-right font-bold text-slate-800 bg-white border rounded-md px-2 py-1"
                        />
                    </div>
                )}
                ...
                {discountAmount > 0 && (
                 ...
                 <div className="flex justify-between text-sm">
                    ...
                    <span className="font-bold text-slate-800">Ksh {taxableAmount.toFixed(2)}</span>
                </div>
                <div className="flex justify-between text-sm">
